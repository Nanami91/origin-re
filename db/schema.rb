...
ActiveRecord::Schema.define(version: 2021_06_21_054810) do
  ...
  create_table "addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["noodle_id"], name: "index_addresses_on_noodle_id"
  end
  ...
  create_table "noodles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  add_foreign_key "addresses", "noodles"
  add_foreign_key "comments", "noodles"
